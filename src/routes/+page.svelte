...
<p class="mb-8 mt-1">
  ...
  environment variables (CLIENT_ID and CLIENT_SECRET variables). After clicking "Submit" a Google OAuth site should pop
  up and you will be able to sign in to a Google account you want to use GDrive-Sync with. <br />Program will create a
  file at /tmp/google_tokens. Keep it secure because sensitive data will be kept there for caching purposes.
</p>
